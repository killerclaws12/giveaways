...
client.giveawaysManager = new GiveawaysManager(client, {
  ...
  default: {
    botsCanWin: false,
    embedColor: "BLUE",
    reaction: "<:taday:996255695420797048>",
    lastChance: {
      enabled: true,
...
client.on("messageCreate", (message) => {
    ...
    if (message.mentions.has(client.user.id)) {
      ...
      .setColor('BLUE')
      .setDescription('<:check:996260712559149116> **My Prefix:** `-` \n<:check:996260712559149116> **Giveaway commands only for slash commands**. \n<:check:996260712559149116> **Support Server: /invite.**')
        message.reply({embeds: [botmention]});
    }
});

// Login through the client
client.login('OTkyNjc0OTUyOTc5NDE1MTMw.GESZDK.WyuWXHPEOFqgwURnSa9MItyqg4zL1n_q5a3khg');
